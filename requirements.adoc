...
* I can
** select patient
** an orderable from concept (i.e. "R/O pulmonary embolism")
** select urgency
...
* I can navigate to a radiology order's form by selecting the
hyperlink on the radiology order's id.
...
* I can navigate to a patients dashboard form by selecting the
hyperlink on the patients's id.
...
STORY:: As a scheduler I want to schedule (set date and time) an existing
...
On a scheduled procedures form

* I can enter
** discontinuation reason (i.e. equipment maintenance, patient did not arrive)
** provider who ordered the discontinuation
* CONDITION: a scheduled procedure can only be discontinued as long as it does
